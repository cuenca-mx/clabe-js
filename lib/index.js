...
function getBankNameByBin(cardNumber) {
  /*
  Devuelve el nombre del banco basado en los primeros 6 dígitos (BIN) de una tarjeta.
  Devuelve null si la entrada es inválida o si el BIN no está registrado.
  */
  if (typeof cardNumber !== 'string' || cardNumber.length < 6) return null;
